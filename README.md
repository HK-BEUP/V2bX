...
**注意： 本项目需要搭配[修改版V2board](https://github.com/HK-BEUP/v2board)**
...
* 因此本项目可能会随想法或思路的变动随性更改项目结构或大规模重构代码，若不能接受请勿使用。
...
[![Stargazers over time](https://starchart.cc/HK-BEUP/V2bX.svg)](https://starchart.cc/HK-BEUP/V2bX)
